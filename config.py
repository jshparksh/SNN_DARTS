...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--load_dir', type=str, default='./searchs/0209_spikeloss0.2/', help='path to load results')
        ...
        parser.add_argument('--learning_rate_alpha', type=float, default=1, help='lr for alpha')
        parser.add_argument('--learning_rate_base', type=float, default=0.5, help='lr for base')
        ...
        parser.add_argument('--arch_epoch', type=int, default=0, help='batch size') # imagenet -> 35
        parser.add_argument('--spike_epoch', type=int, default=5, help='training with spike loss')
    ...
    def __init__(self):
        ...
        self.data_path = './data/' #os.path.join('/data/', self.dataset)
...
class SearchConfigImageNet(BaseConfig):
    def build_parser(self):
        parser = get_parser("Search config")
        parser.add_argument('--name', required=True)
        parser.add_argument('--dataset', type=str, default='IMAGENET', help='CIFAR10 / CIFAR100 / MNIST / IMAGENET')
        parser.add_argument('--load', type=bool, default=False, help='load pretrained model')
        parser.add_argument('--save_dir', type=str, default='./searchs/', help='path to save results')
        parser.add_argument('--load_dir', type=str, default='./searchs/0209_spikeloss0.2/', help='path to load results')
        parser.add_argument('--load_epoch', type=str, default=0, help='load pretrained model from specific epoch')
        parser.add_argument('--batch_size', type=int, default=128, help='batch size')
        parser.add_argument('--learning_rate', type=float, default=0.5, help='lr for weights')
        parser.add_argument('--learning_rate_alpha', type=float, default=0.5, help='lr for alpha')
        parser.add_argument('--learning_rate_base', type=float, default=0.1, help='lr for base')
        parser.add_argument('--arch_learning_rate', type=float, default=3e-4, help='learning rate for arch encoding')
        parser.add_argument('--arch_weight_decay', type=float, default=1e-3, help='weight decay for arch encoding')
...
class AugmentConfigImageNet(BaseConfig):
    def build_parser(self):
        parser = get_parser("Augment config")
        parser.add_argument('--name', required=True)
        parser.add_argument('--dataset', type=str, default='IMAGENET', help='CIFAR10 / CIFAR100 / MNIST / IMAGENET')
        ...
        parser.add_argument('--init_pact_alpha', type=int, default=5)
        parser.add_argument('--init_log_alpha', type=int, default=20)
        parser.add_argument('--init_base', type=int, default=2)
        ...
        parser.add_argument('--cutout_length', type=int, default=16, help='cutout length')
        parser.add_argument('--drop_path_prob', type=float, default=0, help='drop path prob')
        parser.add_argument('--time_step', type=int, default=6, help='timestep for logarithmic spike')
        parser.add_argument('--warmup', type=int, default=5, help='alpha, base requires_grad switch into true')
        parser.add_argument('--alpha_base_fix_epoch', type=int, default=100, help='alpha & base requires_grad switch into false')
