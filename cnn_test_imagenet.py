...
trainset = torchvision.datasets.ImageFolder(root='./dataset/imagenet/train', transform=train_transform)
testset = torchvision.datasets.ImageFolder(root='./dataset/imagenet/val', transform=valid_transform)
